...
export default function ClassListing({ classes, user }: ClassListingProps) {
    ...
    <div className="grid lg:grid-cols-[280px_1fr] h-[calc(100vh-2rem)] max-h-[calc(100vh-2rem)] gap-2 p-4 pt-2">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between gap-2 px-4 py-2">
          ...
          <ClassForm userSchoolId={user?.schoolId??""} />
        </div>
      ...
      {selectedClass ? (
        <div className="flex flex-col gap-2 rounded-lg border bg-card">
          <div className="flex items-center justify-between gap-2 px-4 py-2 border-b">
            ...
            <StreamForm classId={selectedClass} userSchoolId={user?.schoolId??""} />
          </div>
